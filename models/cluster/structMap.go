...
const SelectCloudCluster = "select config_file,cert_data,ca_data,key_data,network_cart,cluster_id,cluster_alias,last_modify_time,docker_version,docker_install_dir,cluster_type,cluster_name,create_time,create_user from cloud_cluster"
