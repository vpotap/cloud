...
const SelectDeployImage = `select c.image_id as image_id,a.cluster_name as cluster_name, c.tags,c.name as name, a.server_domain as server_domain,a.server_address  as server_address from
